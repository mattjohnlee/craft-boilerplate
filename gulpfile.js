...
gulp.task('dev', ['sass:development', 'uglify:development', 'watch:development', 'browser-sync']);
...
gulp.task('watch:development', function() {
  ...
  gulp.watch('web/static/js/*.js', ['uglify:development']);
  gulp.watch('web/static/js/**/*.js', ['uglify:development']);
...
gulp.task('uglify:development', function() {
  return gulp.src([
